...
<!--Init Javascript -->
    ...
    <script type="text/javascript" src="html/components/revolution_slider/js/jquery.themepunch.plugins.min.js"></script>
	...
	<!-- app -->
	<script type="text/javascript" src="html/components/sysweb/src/apps/app.js"></script>
	<!-- menus -->
	<script type="text/javascript" src="html/components/sysweb/src/controllers/Menu.js"></script>
